...
function renderCanvas(canvas) {
    ...
    canvas.width = size;
    canvas.height = size;
    canvas.style.zoom = 1 / this.highDefinition;
...
var QRCode = createReactClass({
    PropTypes: {
        ...
        highDefinition: PropTypes.number
    },
    ...
    render: function() {
        var size = this.props.size * this.props.highDefinition;
            ...
            <View>
                <Canvas
                    context={{
                        ...
                        highDefinition: this.props.highDefinition
                    }}
                    render={renderCanvas}
